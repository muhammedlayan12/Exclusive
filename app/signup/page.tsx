    ...
    <div>
        ...
        <section className="flex font-poppins justify-center gap-16 px-4 py-18 items-center  flex-wrap text-center my-20">
            ...
            <div className="flex flex-col gap-5">
                <h1 className="sm:text-[1.5em] text-[1.1em] font-poppins font-[501]">Create an account</h1>
                <p className="text-[#838383] font-poppins">Enter your details below</p>
                <form className="flex flex-col gap-6">
                    <input className="py-2 pl-2 sm:pr-20  border border-b-[#838383] outline-none" type="text" placeholder="Name"/>
                ...
                <div className="flex flex-col gap-2">
                    <button className="py-2 sm:px-20 px-14 sm:text-[1em] text-[0.85em] bg-red-500 text-white rounded-md">Create Account</button>
                    <button className="py-2 sm:px-20 px-14 sm:text-[1em] text-[0.85em]  text-black border border-black rounded-md">Sign up With Google</button>
